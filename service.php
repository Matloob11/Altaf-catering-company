...
<head>
    ...
    <meta charset="utf-8">
    <title>Professional Catering Services in Pakistan | Altaf Catering</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta
        content="catering services, wedding catering, corporate catering, food services, event catering, Pakistani catering, buffet service, party catering, professional catering"
        name="keywords">
    <meta
        content="Altaf Catering offers premium catering services for weddings, corporate events, and special occasions in Pakistan. Professional staff, customized menus, and exceptional service quality."
        name="description">
    <meta name="robots" content="index, follow">
    <meta name="author" content="Altaf Catering">

    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="Professional Catering Services | Altaf Catering">
    <meta property="og:description"
        content="Premium catering services for weddings, corporate events, and special occasions in Pakistan. Customized menus and professional service.">
    <meta property="og:image" content="img/logo.png">
    <meta property="og:url" content="https://altafcatering.com/service.html">
    <meta property="og:type" content="website">

    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Professional Catering Services | Altaf Catering">
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://altafcatering.com/service.html">
    ...
    <script type="application/ld+json">
    {
      ...
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "MM Farm House Sharif Medical Jati Umrah Road",
      ...
      "telephone": "+923039907296",
      "priceRange": "$$",
      "servesCuisine": ["Pakistani", "Continental", "Chinese", "BBQ"],
      "hasMenu": {
        "@type": "Menu",
        "hasMenuSection": [
          {
            ...
            "description": "Full wedding catering services including elegant food displays and customized menus"
          },
          {
            "@type": "MenuSection",
            "name": "Corporate Catering",
            "description": "Professional catering for meetings, seminars, and office events"
          },
          {
            "@type": "MenuSection",
            "name": "Buffet Services",
            "description": "Large-scale buffet catering for events and celebrations"
          }
        ]
      },
...
<body>
    ...
    <?php $loader_text = "Loading Our Services..."; include 'includes/loader.php'; ?>
    ...
    <div id="services" class="container-fluid service py-6">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                ?>
                <div class="col-lg-3 col-md-6 col-sm-12 wow bounceInUp" data-wow-delay="<?php echo $delay; ?>s">
                    <div class="bg-light rounded service-item">
                        <div class="service-content d-flex align-items-center justify-content-center p-4">
                            <div class="service-content-icon text-center">
                                ...
                                <a href="service-detail.php?id=<?php echo $service['id']; ?>" class="btn btn-primary px-4 py-2 rounded-pill">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-light rounded service-item">
                        <div class="service-content d-flex align-items-center justify-content-center p-4">
                            <div class="service-content-icon text-center">
                                ...
                                <a href="#service-1" class="btn btn-primary px-4 py-2 rounded-pill">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial-item rounded bg-light" itemscope itemtype="http://schema.org/Review">
                    <div class="d-flex mb-3">
                        <img src="img/testimonial-1.jpg" class="img-fluid rounded-circle flex-shrink-0"
                            alt="Ayesha Khan" itemprop="image">
