...
$terms_file = 'admin/data/terms.json';
...
<head>
    <meta charset="utf-8">
    <title>Terms & Conditions — Altaf Catering Company</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta name="keywords" content="terms and conditions, terms of service, legal, Altaf Catering">
    <meta name="description"
        content="Terms & Conditions for Altaf Catering. Please read our legal terms and conditions before using our services. Last Updated: November 2025.">
    <link rel="canonical" href="https://altafcatering.com/terms.html" />
...
<body>
    ...
    <?php $loader_text = "Loading Terms & Conditions..."; include 'includes/loader.php'; ?>
    ...
    <div class="container-fluid bg-light py-6 my-6 mt-0">
        <div class="container text-center animated bounceInDown">
            <h1 class="display-1 mb-4"><?php echo htmlspecialchars($terms['page_title']); ?></h1>
            <ol class="breadcrumb justify-content-center mb-0 animated bounceInDown">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item text-dark" aria-current="page">terms</li>
            </ol>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 700px;">
                <h2 class="display-6 mb-4"><?php echo htmlspecialchars($terms['page_title']); ?></h2>
                <p class="text-muted fs-5"><?php echo htmlspecialchars($terms['page_subtitle']); ?></p>
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-lg-8">
                    <div class="alert alert-info text-center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <strong>Last Updated:</strong> <?php echo htmlspecialchars($terms['last_updated']); ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                ?>
                <div class="col-lg-6">
                    <div class="terms-card h-100 wow <?php echo $animationClass; ?>" data-wow-delay="<?php echo $delay; ?>s">
                    ...
                    <div class="text-center wow fadeInUp" data-wow-delay="<?php echo $delay + 0.2; ?>s">
                        <div class="bg-light rounded-4 p-5">
                            ...
                            <div class="d-flex justify-content-center gap-3 flex-wrap">
                                ...
                                <a href="tel:+923039907296" class="btn btn-outline-primary rounded-pill px-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            <span class="text-body mb-3"><i class="fa fa-check text-primary me-2"></i>Cheese Burger</span>
                            <span class="text-body mb-3"><i class="fa fa-check text-primary me-2"></i>Sandwich</span>
                            <span class="text-body mb-3"><i class="fa fa-check text-primary me-2"></i>Panner Burger</span>
                            <span class="text-body mb-3"><i class="fa fa-check text-primary me-2"></i>Special Sweets</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
